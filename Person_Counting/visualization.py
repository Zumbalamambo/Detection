...
#                                 dtype=np.int32, delimiter=',')    # sat
# id_count_0310_front = np.loadtxt('./outputs/id_accumulated_counter_20170310_front_SSD512x1024_sort_ma10_mh1.txt',
#                                  dtype=np.int32, delimiter=',')   # fri
id_count_0419_front = np.loadtxt('./outputs/id_accumulated_counter_20170419_front_SSD512x1024_sort_ma10_mh3.txt',
                                 dtype=np.int32, delimiter=',')      # wed
id_count_0419_side = np.loadtxt('./outputs/id_accumulated_counter_20170419_side_SSD512x1024_sort_ma10_mh3.txt',
                                dtype=np.int32, delimiter=',')      # wed
...
id_count_0419_front_1dim = id_count_0419_front.ravel()
id_count_0419_side_1dim = id_count_0419_side.ravel()
...
id_count_per_min_0419_front = np.append(id_count_0419_front_1dim[0], np.diff(id_count_0419_front_1dim))
id_count_per_min_0419_side = np.append(id_count_0419_side_1dim[0], np.diff(id_count_0419_side_1dim))
...
id_count_per_min_0419_front_smoothed = smooth(id_count_per_min_0419_front, window_len=window_len, window='blackman')[window_len_half:-window_len_half]
id_count_per_min_0419_side_smoothed = smooth(id_count_per_min_0419_side, window_len=window_len, window='blackman')[window_len_half:-window_len_half]
...
# plt.legend(['20170310 Fri. Front', '20170304 Sat. Side'], loc='best')
plt.plot(times, id_count_per_min_0419_front_smoothed, '-b')
plt.plot(times, id_count_per_min_0419_side_smoothed, '-.r')
plt.legend(['Front', '20170419 Wed. Side'], loc='best')
plt.title('Count per Minute on 20170419 Wed.')
